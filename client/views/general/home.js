...
.controller('HomeCtrl', function($rootScope, $scope, $state, $firebaseObject, $http, User, $window, Map){
  ...
  $scope.findLocation = function(location){
    ...
    Map.geocode(location, function(result){
      ...
      $window.jQuery.get('https://api.flickr.com/services/rest/?method=flickr.photos.search&tags=' + location.toUpperCase() + '&api_key=ea15c092788c7cfb6911fa14efe1d88f&per_page=10&format=json&nojsoncallback=1',
      function(data){
